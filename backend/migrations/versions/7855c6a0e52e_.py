...
Revision ID: 7855c6a0e52e
Revises: 
Create Date: 2025-02-18 01:57:11.146369
...
def upgrade() -> None:
    ...
    sa.Column('ai_url', sa.Text(), nullable=False),
    sa.Column('create_at', sa.DateTime(), nullable=False),
